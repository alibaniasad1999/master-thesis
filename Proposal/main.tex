...
\begin{itemize}
	\item  طراحی یک بازیکن حهت هدایت به کمک یادگیری تقویتی
...
\begin{table}[H]
	...
	\begin{tabular}{|P{3cm}|P{10cm}|}
		...
		\hline
		\multirow{4}{*}{\textbf{تابستان سال اول}} & انجام مطالعه و مروری جامع در زمینه بازی دیفرانسیلی و یادگیری . \\
		\cline{2-2}
		&
        بررسی و تعریف دقیق مسأله یادگیری تقویتی و هدایت به وسیله یادگیری تقویتی در فصای سه‌جسم.
          \\
		\cline{2-2}
