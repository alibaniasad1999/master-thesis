...
\begin{frame}
  \frametitle{Return Distribution Across Robustness Scenarios MARL}
  \vspace{-0.2cm}
  \begin{columns}[T]
    ...
    \begin{column}{0.50\textwidth}
      ...
      \scalebox{0.75}{%
        \begin{tabular}{@{} >{\raggedright\arraybackslash}p{3.05cm} *{8}{c} @{}}
          ...
          Model Mismatch            & 5.48 & \textbf{0.86} & 2.37 & 4.32 & \textbf{0.00} & \textbf{0.00} & 0.20 & \textbf{0.00} \\
          Partial Observation       & 5.37 & \textbf{1.03} & 2.33 & 4.10 & \textbf{0.00} & \textbf{0.00} & 0.20 & \textbf{0.00} \\
          Sensor Noise              & 5.48 & \textbf{0.86} & 2.37 & 4.30 & \textbf{0.00} & \textbf{0.00} & 0.20 & \textbf{0.00} \\
          Time Delay                & 5.51 & \textbf{0.76} & 2.11 & 5.12 & \textbf{0.00} & \textbf{0.00} & 0.20 & \textbf{0.00} \\
          \bottomrule
        \end{tabular}
      }
      \par
