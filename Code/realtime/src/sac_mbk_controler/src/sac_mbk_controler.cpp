...
public:
    ControllerServiceNode() : Node("controller_service_node"), model_path_("/home/ali/Documents/University/master-thesis/Code/realtime/src/sac_mbk_controler/model/sac_mbk_pi_model.pt") {
