...
def data4latex(num):
    for i in os.listdir():
        ...
        if os.path.isfile(data_dir):
            ...
            # check if there is a directory for the file
            if not os.path.exists("../../../../Report/plots/standard/violin_plot/"):
                os.makedirs("../../../../Report/plots/standard/violin_plot/")
                print("Directory created")
            save_dir = "../../../../Report/plots/standard/violin_plot/" + i + ".dat"
            print(save_dir)
