...
class Logger:
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None):
        ...
        """
        self.pytorch_saver_elements = None
        if proc_id() == 0:
    ...
    def save_config(self, config):
        ...
        handling anything that can't be serialized in a graceful way (writing
    ...
    def save_state(self, state_dict, itr=None):
        ...
        if proc_id() == 0:
            ...
            try:
                ...
                log('Warning: could not pickle state_dict.', color='red')
