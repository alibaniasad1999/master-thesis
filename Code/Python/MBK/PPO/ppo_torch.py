...
Original file is located at
    https://colab.research.google.com/github/alibaniasad1999/master-thesis/blob/main/Code/Python/MBK/PPO/ppo_torch.ipynb
"""
...
class PPO:
    ...
    def load(self, filepath='model/actor_critic_torch.pth'):
        ...
        print(colorize(f"Model loaded to {filepath} 🔥😎😌🥰", 'green'))
