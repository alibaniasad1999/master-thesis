...
# Load CSV files
state = pd.read_csv('../../../../Code/Python/TBP/SAC/Standard/results/state.csv')
state.to_csv('state.csv', index=False)
action = pd.read_csv('../../../../Code/Python/TBP/SAC/Standard/results/action.csv')

# Load CSV files
state_zs = pd.read_csv('../../../../Code/Python/TBP/SAC/ZeroSum/results/state.csv')
state_zs.to_csv('state_zs.csv', index=False)
action_zs = pd.read_csv('../../../../Code/Python/TBP/SAC/ZeroSum/results/action.csv')
