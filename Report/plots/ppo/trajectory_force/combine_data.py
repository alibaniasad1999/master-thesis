...
# Load CSV files
state = pd.read_csv('../../../../Code/Python/TBP/PPO/Standard/results/state.csv')
state.to_csv('state.csv', index=False)
action = pd.read_csv('../../../../Code/Python/TBP/PPO/Standard/results/action.csv')

# Load CSV files
state_zs = pd.read_csv('../../../../Code/Python/TBP/PPO/ZeroSum/results/state.csv')
state_zs.to_csv('state_zs.csv', index=False)
action_zs = pd.read_csv('../../../../Code/Python/TBP/PPO/ZeroSum/results/action.csv')
