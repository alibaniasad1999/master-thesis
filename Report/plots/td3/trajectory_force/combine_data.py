...
# Load CSV files
state = pd.read_csv('../../../../Code/Python/TBP/TD3/Standard/results/state.csv')
state.to_csv('state.csv', index=False)
action = pd.read_csv('../../../../Code/Python/TBP/TD3/Standard/results/action.csv')

# Load CSV files
state_zs = pd.read_csv('../../../../Code/Python/TBP/TD3/ZeroSum/results/state.csv')
state_zs.to_csv('state_zs.csv', index=False)
action_zs = pd.read_csv('../../../../Code/Python/TBP/TD3/ZeroSum/results/action.csv')
