...
عامل گرادیان سیاست عمیق قطعی تاخیری دوگانه چند­عاملی\LTRfootnote{Multi-Agent Twin Delayed Deep Deterministic Policy Gradient (MATD3)}
...
\subsection{شبه‌کد \lr{MATD3} برای بازی‌های چندعاملیِ مجموع­‌صفر}
...
\lr{MATD3} مزایای زیر را نسبت به \lr{MADDPG} در بازی‌های چندعاملیِ مجموع­‌صفر ارائه می‌دهد:
...
در مجموع، \lr{MATD3} ترکیبی از بهترین ویژگی‌های \lr{TD3} و \lr{MADDPG} را ارائه می‌دهد که آن را به گزینه‌ای مناسب برای یادگیری سیاست‌های پیچیده در بازی‌های چندعاملیِ مجموع­‌صفر تبدیل می‌کند.