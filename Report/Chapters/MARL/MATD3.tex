\section{عامل گرادیان سیاست عمیق قطعی تاخیری دوگانه دو­عاملی}\label{sec:MATD3}

عامل گرادیان سیاست عمیق قطعی تاخیری دوگانه دو­عاملی\LTRfootnote{Multi-Agent Twin Delayed Deep Deterministic Policy Gradient (MATD3)}
توسعه‌ای از الگوریتم \lr{TD3} برای محیط‌های چند­عاملی است. در این بخش، به بررسی این الگوریتم در چارچوب بازی‌های دو­عاملیِ مجموع­‌صفر می‌پردازیم که در آن ترکیب ویژگی‌های \lr{TD3} با رویکرد چند­عاملی \lr{MADDPG} به پایداری و کارایی بیشتر در یادگیری منجر می‌شود.

\subsection{چالش‌های یادگیری تقویتی در محیط‌های چند­عاملی و راه‌حل \lr{MATD3}}
...
\lr{MATD3} هر دو چالش را با ترکیب رویکردهای زیر حل می‌کند:
\begin{itemize}
...
\subsection{معماری \lr{MATD3} در بازی‌های مجموع­‌صفر}
...
\subsection{آموزش \lr{MATD3}}

فرایند آموزش \lr{MATD3} به شرح زیر است:
...
\subsection{اکتشاف در \lr{MATD3}}

اکتشاف در \lr{MATD3} با افزودن نویز به اعمال هر عامل انجام می‌شود:
...
\subsection{شبه‌کد \lr{MATD3} برای بازی‌های دو­عاملیِ مجموع­‌صفر}

در این بخش، شبه‌کد الگوریتم \lr{MATD3} پیاده‌سازی‌شده آورده شده‌است. در این پژوهش الگوریتم~\رجوع{alg:MATD3} در محیط پایتون با استفاده از کتابخانه \lr{PyTorch} \cite{paszke2017automatic} پیاده‌سازی شده‌است.
...
\subsection{مزایای \lr{MATD3} در بازی‌های مجموع­‌صفر}

\lr{MATD3} مزایای زیر را نسبت به \lr{MADDPG} در بازی‌های دو­عاملیِ مجموع­‌صفر ارائه می‌دهد:
...
در مجموع، \lr{MATD3} ترکیبی از بهترین ویژگی‌های \lr{TD3} و \lr{MADDPG} را ارائه می‌دهد که آن را به گزینه‌ای مناسب برای یادگیری سیاست‌های پیچیده در بازی‌های دو­عاملیِ مجموع­‌صفر تبدیل می‌کند.