...
عملگرد نقاد نرم\LTRfootnote{Soft Actor Critic (SAC)}
 ...
 \lr{TD3}
  نیست (زیرا تقریباً همزمان منتشر شده است)، اما ترفند یادگیری دوگانه محدود شده را در خود جای داده است و به دلیل سیاست تصادفی \lr{SAC}، از چیزی روشی به نام صاف کردن سیاست هدف\LTRfootnote{Target Policy Smoothing}
    استفاده شده‌است.
...
آنتروپی معیاری از تصادفی بودن انتخاب عمل در سیاست است.
 ...
 برای توضیح \lr{SAC}، ابتدا باید بررسی یادگیری تقویتی تنظیم‌شده با آنتروپی\LTRfootnote{Entropy-Regularized Reinforcement Learning}
  را پرداخته شود. در \lr{RL} تنظیم‌شده با آنتروپی، روابط تابع ارزش کمی متفاوت است.
          ...
          روش بهینه‌سازی سیاست از ترفند پارامترسازی مجدد\LTRfootnote{Reparameterization}
           ...
           \(\pi_{\theta}(\cdot|s)\)
            ...
            \cite{DBLP:journals/corr/abs-1801-01290}،
             از یک سیاست گاوسی\LTRfootnote{Squashed Gaussian Policy}
