...
الگوریتم
\lr{TD3}\LTRfootnote{Twin Delayed Deep Deterministic Policy Gradient}
 ...
 در حالی که \lr{DDPG} گاهی اوقات می‌تواند عملکرد بسیار خوبی داشته باشد، اما اغلب نسبت به فراپارامترها و سایر انواع تنظیمات حساس است. یک حالت رایج شکست برای \lr{DDPG} این است که تابع \lr{Q} یادگرفته شده شروع به بیش برآورد چشمگیر مقادیر \lr{Q} می‌کند که منجر به شکستن سیاست می‌شود، زیرا از خطاهای تابع \lr{Q} به‌صورت چشمگیری افزایش می‌یابد.
 الگوریتم
